...
declare module '$env/static/private' {
	...
	export const npm_config_onlyBuiltDependencies_: string;
	...
	export const npm_config___esbuild: string;
	export const npm_execpath: string;
	export const PAGER: string;
	export const npm_config_approve_builds: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_config_onlyBuiltDependencies_: string;
		...
		npm_config___esbuild: string;
		npm_execpath: string;
		PAGER: string;
		npm_config_approve_builds: string;
		LSCOLORS: string;
